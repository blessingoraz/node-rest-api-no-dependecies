 ...
 */
 ...
 workers.validateCheckData = (originalCheckData) => {
    ...
    originalCheckData.successCodes = typeof originalCheckData.method == 'object' && originalCheckData.successCodes instanceof Array && originalCheckData.successCodes.length > 0
 ...
 workers.performCheck = (originalCheckData) => {
    ...
    const _modoleToUse = originalCheckData.protocol == 'http' ? http : https
    const req = _modoleToUse.request(requestDetails, (res) => {
...
workers.processCheckOutcome = (originalCheckData, checkOutcome) => {
    ...
    originalCheckData.lastChecked = lastChecked
